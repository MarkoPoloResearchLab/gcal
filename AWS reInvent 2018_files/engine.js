...
dwr.engine._pathToDwrServlet = "/connect/dwr";
}


dwr.engine._contextPath = "/connect";
...
document.cookie = "DWRSESSIONID=" + dwrsess + "; path=" + (dwr.engine._contextPath != "" ? dwr.engine._contextPath : "/") + (("https:" == document.location.protocol) ? "; secure": "");
